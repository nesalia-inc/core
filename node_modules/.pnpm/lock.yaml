...
importers:
  ...
  .:
    devDependencies:
      '@changesets/cli':
        specifier: ^2.27.0
        version: 2.30.0(@types/node@12.20.55)
      '@eslint/js':
        specifier: ^9.0.0
        version: 9.39.3
      eslint:
  ...
  packages/core:
    devDependencies:
      '@vitest/coverage-v8':
        specifier: ^2.0.0
        version: 2.1.9(vitest@2.1.9(@types/node@12.20.55))
      typescript:
        specifier: ^5.0.0
        version: 5.9.3
      vitest:
        specifier: ^2.0.0
        version: 2.1.9(@types/node@12.20.55)
...
snapshots:
  ...
  '@changesets/cli@2.30.0(@types/node@12.20.55)':
    dependencies:
      '@changesets/apply-release-plan': 7.1.0
      '@changesets/assemble-release-plan': 6.0.9
      '@changesets/changelog-git': 0.2.1
  ...
  '@vitest/coverage-v8@2.1.9(vitest@2.1.9(@types/node@12.20.55))':
    dependencies:
      '@ampproject/remapping': 2.3.0
      '@bcoe/v8-coverage': 0.2.3
      debug: 4.4.3
      ...
      test-exclude: 7.0.2
      tinyrainbow: 1.2.0
      vitest: 2.1.9(@types/node@12.20.55)
    transitivePeerDependencies:
      - supports-color
  ...
  '@vitest/mocker@2.1.9(vite@5.4.21(@types/node@12.20.55))':
    dependencies:
      '@vitest/spy': 2.1.9
      estree-walker: 3.0.3
      magic-string: 0.30.21
    optionalDependencies:
      vite: 5.4.21(@types/node@12.20.55)
  ...
  vite-node@2.1.9(@types/node@12.20.55):
    dependencies:
      cac: 6.7.14
      debug: 4.4.3
      es-module-lexer: 1.7.0

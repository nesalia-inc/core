File-system conventions: loading.js | Next.js[Skip to content](#geist-skip-nav)
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/03-file-conventions/loading.mdx) Scroll to top
...
layout.js](/docs/app/api-reference/file-conventions/layout)[Next
...
[Docs](/docs)[Support Policy](/support-policy)[Learn](/learn)[Showcase](/showcase)[Blog](/blog)[Team](/team)[Analytics](https://vercel.com/analytics?utm_source=next-site&utm_medium=footer&utm_campaign=docs_app_api-reference_file-conventions_loading)[Next.js Conf](/conf)[Previews](https://vercel.com/products/previews?utm_source=next-site&utm_medium=footer&utm_campaign=docs_app_api-reference_file-conventions_loading)[Evals](/evals)

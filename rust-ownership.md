...
[Listing 4-1](#listing-4-1): A variable and the scope in which it is valid
...
[`drop`](../std/ops/trait.Drop.html#tymethod.drop), and it’s where the author of `String` can put
...
[Listing 4-2](#listing-4-2): Assigning the integer value of variable `x` to `y`
...
[Listing 4-3](#listing-4-3): Functions with ownership and scope annotated
...
[Listing 4-4](#listing-4-4): Transferring ownership of return values
...
[Listing 4-5](#listing-4-5): Returning ownership of parameters

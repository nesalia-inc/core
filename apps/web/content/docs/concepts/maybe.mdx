---
title: Maybe
description: Handle optional values without null and undefined
---
...
- [Result](./result.mdx) - For operations that can fail
- [Try](./try.mdx) - For wrapping functions that might throw

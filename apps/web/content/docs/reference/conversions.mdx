...
```typescript
import { fromMaybe } from '@deessejs/core';
...
```typescript
import { fromResult } from '@deessejs/core';
...
```typescript
import { resultFromThrowable, mapErr } from '@deessejs/core';
...
```typescript
import { some, toMaybeFromResult, flatMap, fromNullable } from '@deessejs/core';

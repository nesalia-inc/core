...
[Read more about why to switch](/docs#the-problem-with-traditional-error-handling)
...
<Cards>
  ...
  <Card title="Why not try/catch?" href="/docs#the-problem-with-traditional-error-handling">

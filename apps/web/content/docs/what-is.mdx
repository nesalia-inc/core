---
title: What is deessejs/fp
description: Type-safe error handling for TypeScript with Result, Maybe, and AsyncResult monads
icon: Shield
---
...
With try/catch, the type system cannot tell you what can fail.
...
<Cards>
  ...
  <Card title="Error" href="/docs/core/error">
    Structured domain errors with enrichment
  </Card>
</Cards>

---
title: Installation
description: How to install and set up @deessejs/fp in your project
icon: Rocket
---
...
- **[Result](/docs/core/result)** - Type-safe error handling
- **[Quick Start](/docs/quick-start)** - More examples
